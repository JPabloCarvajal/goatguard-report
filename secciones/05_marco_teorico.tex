...
el protocolo de la capa siguiente. A continuación aparece el 
encabezado IP de veinte bytes en su versión mínima, que contiene las 
direcciones IP de origen y destino, el identificador de protocolo de 
transporte, el TTL y el checksum de cabecera. Por último se ubica el 
encabezado de transporte: veinte bytes para TCP, con números de 
secuencia y acuse, tamaño de ventana y banderas de control, u ocho 
bytes para UDP, con puertos y longitud del datagrama 
